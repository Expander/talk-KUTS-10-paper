...
\begin{frame}{5 Theoretical uncertainties}
  \begin{itemize}
  \item Uncertainty of EFT calculation
  \item Uncertainty of fixed-order calculation
  \item Uncertainty of hybrid calculation
  \item Combined uncertainty expected to be smaller than uncertainty of pure EFT or pure fixed-order calculations
  \end{itemize}
\end{frame}
