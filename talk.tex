...
\begin{frame}{4.3 Status}
  Status of all spectrum generators described in detail.
  Summary table:
  \begin{table}
  ...
  $^{***}$NNLO + NNLL coming soon (see talk by Thomas Kwasnitza)
\end{frame}
...
\begin{frame}{4.5 Prospects}
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=\textwidth]{{{plots/kuts-9/4.5}}}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
...
\begin{frame}{4.5.1 Prospects -- non-SM EFTs}
  ...
  \begin{center}
    \includegraphics[width=0.49\textwidth]{{{plots/kuts-9/FH}}}
  \end{center}
\end{frame}
...
\begin{frame}{4.5.2 Prospects -- non-MSSM UV models}
  ...
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[width=0.49\textwidth]{{{plots/kuts-9/FS_TB-20_Xt--sqrt6}}} &
      \includegraphics[width=0.49\textwidth]{{{plots/kuts-9/SP_TB-20_Xt--sqrt6}}} \\
      \fs & \SARAH/\SPheno
    \end{tabular}
  \end{center}
\end{frame}
